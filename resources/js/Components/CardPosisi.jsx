...
export default function CardPosisi({ positions, setSelectedPosition }) {
  return (
    <div className="w-full h-full overflow-y-auto bg-white rounded-lg">
      ...
      {/* Wrapper untuk card, dengan max-h agar menampilkan maksimal 4 card */}
      <div className="max-h-[640px] overflow-y-auto"> {/* 4 cards dengan masing-masing h-36 = 144px */}
        {positions.slice(0, positions.length).map((position) => (
          <div
            key={position.id}
