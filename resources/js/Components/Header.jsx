        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                <Link href="/register" className="block w-full text-center bg-[#162360] text-white px-4 py-2 rounded hover:bg-blue-800 font-semibold text-base">
                  Registrasi
                </Link>
                <Link href="/login" className="block w-full mt-2 text-center bg-white text-[#162360] px-4 py-2 rounded hover:bg-gray-100 font-semibold text-base">
                  Masuk
                </Link>
              </div>
            </div>
