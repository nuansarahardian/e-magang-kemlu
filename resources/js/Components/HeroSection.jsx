...
export default function HeroSection() {
    return (
        <section className="relative h-auto lg:h-[90vh] flex items-center justify-center bg-gradient-to-br from-[#f0f4f8] to-[#dfe3f6]">
            ...
            {/* Container */}
            <div className="relative container mx-auto px-8 py-12 lg:py-16 flex flex-col lg:grid lg:grid-cols-2 items-center justify-between gap-6 lg:gap-x-12">
                ...
                >
                    <h1
                        ...
                        style={{
                            lineHeight: "1.8", // Tighter line height for headings
                    ...
                    <p
                        className="text-[#86858D] text-sm sm:text-base lg:text-md" // Changed description text color
                        style={{
                    ...
                    >
                        Daftar Magang di BSKLN Kementerian Luar Negeri RI dan
                        Tingkatkan Pengalamanmu dalam Diplomasi Global.
                    </p>
                    <motion.a
                        href="/posisi-magang"
