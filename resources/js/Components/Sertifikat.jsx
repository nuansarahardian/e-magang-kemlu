                        ...
                        >
                                ...
                                <div className="text-base leading-7 text-gray-800 mb-2">
                                    ...
                                    <div className="flex gap-1 mb-6 justify-center">
                                        ...
                                        <div className="col-span-7 text-sm text-left">
                                            <p>{historiPendaftaran[0].nama}</p>

                                            <p>{historiPendaftaran[0].nim}</p>
                                            <p>
                                                {historiPendaftaran[0].jurusan}
                                            </p>
                                            <p>
                                                {historiPendaftaran[0].fakultas}
                                            </p>
                                            <p>
                                                {
                                    ...
                                    <p className="text-center ">
                                        ...
                                        magang di unit kerja Badan Strategi
                                        Kebijakan Luar Negeri (BSKLN),
                                        Kementerian Luar Negeri RI, pada tanggal{" "}
                                        <b>
                                            {
                                                historiPendaftaran[0]
                                                    .tanggal_mulai
                                        ...
                                        pada{" "}
                                        {historiPendaftaran[0].posisi_magang}.
                                    </p>
                                </div>
                            )}
                            ...
                            <div className="flex justify-between items-center w-full">
                                <div className="w-28 h-36 border border-gray-300 flex items-center justify-center text-gray-500 text-sm">
                                    <img
                                        src={historiPendaftaran[0].pas_foto}
                                        alt=""
                                    />
                                </div>
                                ...
                                <div className="text-center text-sm">
                                    <p>
                                        Jakarta,{" "}
                                        {historiPendaftaran[0].tanggal_berakhir}
                                    </p>
                                    <p className="mb-20">
